...
final class ExternalAuthEvents {
  ...
  /**
   * Name of the event fired after a Drupal user was registered after
  ...
  /**
   * Name of the event fired to alter the authmap data before it is stored in
   * the database.
   *
   * This event allows modules to alter the data from the external
   * authentication service that will be stored in Drupal, to map Drupal users
